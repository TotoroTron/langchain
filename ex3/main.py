...
question = """
    ...
    For educational purposes, make obvious syntax errors in the Python code to trip an interpreter error for the first two iterations of this cycle to demonstrate functionality of the langgraph model. 
